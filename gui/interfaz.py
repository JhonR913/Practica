    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("""
            QMainWindow {
                ...
                color: #E0E0E0;
                font-size: 16px;  /* Cambiar el tamaño de la letra */
            }
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 760, 409))
        ...
        self.configuracionBtn.clicked.connect(lambda: self.stackedWidget.setCurrentIndex(4))
